    ...
    def self.holidays_by_month
      {
            ...
            {:function => lambda { |year| Holidays.easter(year)-46 }, :function_id => "easter(year)-46", :type => :informal, :name => "Cinzas", :regions => [:br]}],
      ...
      7 => [{:mday => 9, :name => "Revolução Constitucionalista", :regions => [:br]}],
